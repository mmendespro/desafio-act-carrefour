...
public class CreateContaCommand extends SelfValidating<CreateContaCommand> implements Command {
    ...
    public CreateContaCommand(String contaId, String contaNome, String tipo, String contaPai) {
